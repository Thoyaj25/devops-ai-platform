/*
  ...
  - The values [QUEUED,RUNNING,HEALTHY] on the enum `DeploymentStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "DeploymentStatus_new" AS ENUM ('PENDING', 'CHECKING_OUT', 'BUILDING', 'DEPLOYING', 'HEALTH_CHECKING', 'SUCCESS', 'FAILED', 'ROLLING_BACK', 'ROLLED_BACK', 'SUPERSEDED', 'CANCELLED', 'STOPPED');
